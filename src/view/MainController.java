...
public class MainController implements Observer {
    ...
    public IntegerProperty endTime;
    ...
    public void init(){
        ...
        graphs.controller.hybridlabel.setOpacity(0);
        endTime = new SimpleIntegerProperty();
    ...
    public void initMyMenuBar(){
        ...
        mymenubar.controller.onstartLr = viewmodel.startLearnVM;
        mymenubar.controller.onstartDc = viewmodel.startDetectVM;
    }
    ...
    public void Bind(){
        ...
        endTime.bind(viewmodel.endTimeVM);
        ...
        viewmodel.ValueZSVM.addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observableValue, Number number, Number t1) {
                ...
                if(viewmodel.NameAlgo.getValue().equals("ZScore")) {
                    ...
                    XYChart.Data dt = new XYChart.Data(viewmodel.timeStep.getValue(), viewmodel.ValueZSVM.getValue());
    ...
    public void LinearRegAction(){
        ...
        viewmodel.YVM.addListener((obs, old, nw)->{
            if(viewmodel.NameAlgo.getValue().equals("Linear Regression")){
                ...
                data.getData().add(new XYChart.Data(endTime.getValue(), viewmodel.YVM.getValue()));
    ...
    public void whenNameAlgoChange(){
    ...
    public void whenMouseClickName(){
